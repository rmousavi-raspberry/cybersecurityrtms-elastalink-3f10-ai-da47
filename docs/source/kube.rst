Scaling [cybersecurityrtms-elastalink-3f10-ai-da47] With Kubernetes
===========================
...
Based on your TML solution [cybersecurityrtms-elastalink-3f10-ai-da47] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecurityrtms-elastalink-3f10-ai-da47.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecurityrtms-elastalink-3f10-ai-da47.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecurityrtms-elastalink-3f10-ai-da47.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f qdrant.yml -f privategpt.yml -f cybersecurityrtms-elastalink-3f10-ai-da47.yml

cybersecurityrtms-elastalink-3f10-ai-da47.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecurityrtms-elastalink-3f10-ai-da47.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# cybersecurityrtms-elastalink-3f10-ai-da47.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecurityrtms-elastalink-3f10-ai-da47
     spec:
       selector:
         matchLabels:
           app: cybersecurityrtms-elastalink-3f10-ai-da47
       ...
       template:
         ...
         spec:
           containers:
           - name: cybersecurityrtms-elastalink-3f10-ai-da47
             image: rmousavi/cybersecurityrtms-elastalink-3f10-ai-da47-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'cybersecurityrtms-elastalink-3f10-ai-da47'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10'
             - name: GITUSERNAME
               value: 'rmousavi-raspberry'
             - name: GITREPOURL
               value: 'https://github.com/rmousavi-raspberry/raspberrypitss'
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecurityrtms-elastalink-3f10-ai-da47-visualization-service
       labels:
         app: cybersecurityrtms-elastalink-3f10-ai-da47-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecurityrtms-elastalink-3f10-ai-da47 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecurityrtms-elastalink-3f10-ai-da47.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecurityrtms-elastalink-3f10-ai-da47.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecurityrtms-elastalink-3f10-ai-da47.yml
