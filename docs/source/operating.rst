[cybersecurityrtms-elastalink-3f10-ai-da47] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecurityrtms-elastalink-3f10-ai-da47] container is NOT running**.

.. tip::
   You must have your [cybersecurityrtms-elastalink-3f10-ai-da47] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/rmousavi-raspberry/raspberrypitss/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/rmousavi-raspberry/raspberrypitss  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40579  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='rmousavi-raspberry'  \-\-env DOCKERUSERNAME='rmousavi'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/dashboard-rtms-ai-mitre.html?topic=rtms-pgpt-ai-mitre&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[cybersecurityrtms-elastalink-3f10-ai-da47] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/rmousavi-raspberry/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/cybersecurityrtms-elastalink-3f10-ai-da47
...
.. important::
   VIPERHOST_PRODUCE=172.27.0.166, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.27.0.166, VIPERPORT_PREPROCESS=42893, VIPERHOST_PREPOCESS2=172.27.0.166, VIPERPORT_PREPROCESS2=33555, VIPERHOST_PREPOCESS_PGPT=172.27.0.166, VIPERPORT_PREPROCESS_PGPT=41963, VIPERHOST_ML=172.27.0.166, VIPERPORT_ML=36779, VIPERHOST_PREDCT=172.27.0.166, VIPERPORT_PREDICT=37027, HPDEHOST=172.27.0.166, HPDEPORT=36983, HPDEHOST_PREDICT=172.27.0.166, HPDEPORT_PREDICT=39935

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2527-cybersecurityrtms-elastalink-3f10-ai-da47,solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10, python-preprocess-9271-cybersecurityrtms-elastalink-3f10-ai-da47,solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10, python-preprocess1-4935-cybersecurityrtms-elastalink-3f10-ai-da47,solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10, python-preprocess3-6643-cybersecurityrtms-elastalink-3f10-ai-da47,solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10, python-ai-4031-cybersecurityrtms-elastalink-3f10-ai-da47,solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
